...
$sql = "SELECT c.customer_id,a.acc_id,c.f_name,a.balance,a.opening_date,a_t.acc_type
			FROM customer AS c 
				NATURAL JOIN account_balance AS a 
					NATURAL JOIN account_type AS a_t";
		  ...
		  <div class="col-sm-3">
			...
			<div class="col-sm-9">
			  		<div class="content-box-large">
			  			<div class="row">
			  				<div class="col-sm-2">
			  					<a href="add_account.php"><button class="btn btn-success" type="button">Add Account</button></a>
			  				</div>
			  			</div>

			  				<div class="panel-heading">
								<div class="panel-title text-center"><p>Accounts Information</p></div>
							</div>
